...
public class CommandFactory {
    ...
    public Command createCommand(String commandName) throws CommandFailedException {
        ...
        try {
            return (Command) Class.forName(String.format("it.alten.doublechargg.pawtropolis.game.command.impl.%sCommand", commandName)).getConstructor(GameController.class).newInstance(context.getBean(GameController.class));
